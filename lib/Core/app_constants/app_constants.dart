class AppConstants {
  ...
  static const String screen2SubTitle="Thuna Service streamlines your experience by providing services such as complaint registration,accident GD request,FIR download and more";

  static const String screen3MainTitle="Pol Blood Service";
  static const String screen3SubTitle="Pol Blood Sercices is dedicated to its mission of saving lives by providing blood donation and blood request support to those in need";

  static const String screen4MainTitle="Citizen Saftey Services";
  static const String screen4SubTitle="Saftey Services are committed to ensuring the saftey of all its citizens through features such as Track My Trip.Locked House,Senior Citizen info and more";
  ...
  static const String fifthParagraph="We perform regular backups of the content and will do our best to ensure completeness and accuracy of these backups. In the event of the hardware failure or date loss we will restore backups automatically to minimize the impact and downtime";
  static const String sixthHeadingText="Links to other mobile applications";
  static const String sixthParagraph="Although this Mobile Application may link to other mobile applications, we are not, directly or indirectly, implying any approval, association, sponsorship, endorsement, or affiliation with any linked mobile application, unless specifically stated herein. We are not responsible for examining or evaluating, and we do not warrant the offerings of, any businesses or individuals or the content of their mobile applications. We do not assume any responsibility or liability for the actions, products, services, and content of any other third-parties. You should carefully review the legal statements and other conditions of use of any mobile application which you access through a link from this Mobile Application. Your linking to any other off-site mobile applications is at your own risk";
  static const String seventhHeadingText="Changes and amendments";
  static const String seventhParagraph="We reserve the right to modify this Agreement or its policies relating to the Mobile Application or Services at any time, effective upon posting of an updated version of this Agreement in the Mobile Application. When we do, we will revise the updated date at the bottom of this page. Continued use of the Mobile Application after any such changes shall constitute your consent to such changes.";
  static const String eightHeadingText="Acceptance of these terms";
  static const String eightParagraph="You acknowledge that you have read this Agreement and agree to all its terms and conditions. By using the Mobile Application or its Services you agree to be bound by this Agreement If you do not agree to abide by the terms of this Agreement, you are not authorized to use or access the Mobile Application and its Services";
